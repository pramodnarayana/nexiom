...
import type { FieldMappingRepositoryPort } from '../../core/ports/outbound/field-mapping-repository.port.js';

@Injectable()
export class DrizzleFieldMappingRepositoryAdapter
  extends BaseRepository<typeof integrationStitches>
  implements FieldMappingRepositoryPort
{
  constructor(
