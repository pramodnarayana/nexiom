...
CREATE TYPE "public"."pipeline_status_enum" AS ENUM('RECEIVED', 'PROCESSING', 'REPLICATED', 'NORMALIZED', 'SKIPPED', 'PENDING', 'SUCCESS', 'FAIL', 'RETRY');--> statement-breakpoint
...
CREATE TABLE "connection_storage_registry" (
	...
	"data_namespace" varchar(128) NOT NULL,
...
ALTER TABLE "ui_workspace" ADD CONSTRAINT "ui_workspace_org_id_organization_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "registry_namespace_unique_idx" ON "connection_storage_registry" USING btree ("data_namespace");--> statement-breakpoint
CREATE INDEX "registry_host_idx" ON "connection_storage_registry" USING btree ("database_host_id");--> statement-breakpoint
CREATE INDEX "registry_region_idx" ON "connection_storage_registry" USING btree ("region_context");--> statement-breakpoint
...
CREATE INDEX "ui_workspace_env_idx" ON "ui_workspace" USING btree ("org_id","env_type");--> statement-breakpoint
