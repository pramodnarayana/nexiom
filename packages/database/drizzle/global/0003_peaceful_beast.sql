...
CREATE UNIQUE INDEX IF NOT EXISTS "canonical_mapping_unique_idx" ON "canonical_mappings" USING btree ("app_name","category","entity","view_mode","version");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ai_conv_tenant_idx" ON "ai_conversations" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ai_conv_created_idx" ON "ai_conversations" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ai_msg_conv_idx" ON "ai_messages" USING btree ("conversation_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ai_msg_tenant_idx" ON "ai_messages" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ai_msg_timeline_idx" ON "ai_messages" USING btree ("conversation_id","created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cop_connection_idx" ON "connector_object_profiles" USING btree ("connection_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "gem_unique_mapping_idx" ON "global_entity_map" USING btree ("stitch_id","source_app_id","source_entity_id","dest_app_id","dest_entity_type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "gem_src_lookup_idx" ON "global_entity_map" USING btree ("source_entity_id","source_app_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "gem_dest_lookup_idx" ON "global_entity_map" USING btree ("dest_entity_id","dest_app_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "gem_source_app_idx" ON "global_entity_map" USING btree ("source_app_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "gem_dest_app_idx" ON "global_entity_map" USING btree ("dest_app_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "gem_src_trace_idx" ON "global_entity_map" USING btree ("source_trace_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "gem_dest_trace_idx" ON "global_entity_map" USING btree ("dest_trace_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "gem_stitch_idx" ON "global_entity_map" USING btree ("stitch_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "field_mapping_stitch_canonical_unique_idx" ON "field_mapping" USING btree ("stitch_id","source_canonical");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "stitch_name_workspace_unique_idx" ON "integration_stitch" USING btree ("workspace_id",lower("name"));--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "stitch_workspace_idx" ON "integration_stitch" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "stitch_org_idx" ON "integration_stitch" USING btree ("org_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "stitch_src_conn_idx" ON "integration_stitch" USING btree ("src_connection_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "stitch_dest_conn_idx" ON "integration_stitch" USING btree ("dest_connection_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "stitch_status_idx" ON "integration_stitch" USING btree ("org_id","status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "scheduler_outbox_poll_idx" ON "scheduler_outbox" USING btree ("next_retry_at") WHERE status = 'pending';--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "scheduler_outbox_stitch_idx" ON "scheduler_outbox" USING btree ("stitch_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "sync_cursors_stitch_stream_unique_idx" ON "sync_cursors" USING btree ("stitch_id","stream_name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "sync_cursors_stitch_idx" ON "sync_cursors" USING btree ("stitch_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "app_name_idx" ON "app_connection" USING btree ("app_name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tenant_status_idx" ON "app_connection" USING btree ("tenant_id","status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "connection_expires_at_idx" ON "app_connection" USING btree ("expires_at") WHERE "app_connection"."expires_at" IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "tenant_external_id_unique_idx" ON "app_connection" USING btree ("tenant_id","external_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "tenant_app_display_name_lower_idx" ON "app_connection" USING btree ("tenant_id","app_name",lower("display_name"));--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "workspace_connection_conn_idx" ON "ui_workspace_connection" USING btree ("connection_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "ui_workspace_org_name_lower_unique_idx" ON "ui_workspace" USING btree ("org_id","env_type",lower("name"));--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ui_workspace_org_idx" ON "ui_workspace" USING btree ("org_id");--> statement-breakpoint
