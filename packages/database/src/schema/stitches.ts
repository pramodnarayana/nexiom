...
/**
 * SYNC CURSORS — Polling State (control-plane, public schema)
 *
...
export const syncCursors = pgTable('sync_cursors', {
     ...
     * See SyncStateDocument in packages/engine/src/state/cursor-manager.types.ts.
     */
