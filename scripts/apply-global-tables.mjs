...
const statements = [
  ...
  `CREATE INDEX IF NOT EXISTS "global_registry_outbox_poll_idx" ON "global_registry_outbox" USING btree ("status", "next_retry_at")`,
  `CREATE INDEX IF NOT EXISTS "global_registry_outbox_tenant_idx" ON "global_registry_outbox" USING btree ("tenant_id")`
];
