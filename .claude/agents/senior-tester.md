...
You have a persistent Persistent Agent Memory directory at `/Users/apple/engineering/soopa/.claude/agent-memory/senior-tester/`. Its contents persist across conversations.
